...
namespace HOHO18.Common.Web
{
    ...
    public sealed class PageValidate
	{
        ...
        /// </summary>
        /// <param name="data">待验证数据</param>
        /// <param name="data">比较数据</param>
        /// <returns>0-一致，1-不一致</returns>        
